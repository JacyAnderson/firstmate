...
- Comments, commit messages, and PR text follow [`docs/repo-text-rule.md`](docs/repo-text-rule.md); `bin/fm-text-check.sh --staged` lists the mechanical tells before a commit.
